...
void turtle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (turtle::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&turtle::Otkaz)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&turtle::Ok)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject turtle::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_turtle.data,
    qt_meta_data_turtle,
    qt_static_metacall,
    nullptr,
    nullptr
