...
void OvenTimer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OvenTimer *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (OvenTimer::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OvenTimer::angChange)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject OvenTimer::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_OvenTimer.data,
    qt_meta_data_OvenTimer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TurtlePult *>(_o);
        (void)_t;
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TurtlePult::*)(qreal );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TurtlePult::goUp)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TurtlePult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TurtlePult::goDown)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (TurtlePult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TurtlePult::goLeft)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (TurtlePult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TurtlePult::goRight)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (TurtlePult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TurtlePult::hasLeftWall)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (TurtlePult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TurtlePult::hasRightWall)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (TurtlePult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TurtlePult::noUpWall)) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (TurtlePult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TurtlePult::noDownWall)) {
                *result = 7;
                return;
            }
        }
        {
            using _t = void (TurtlePult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TurtlePult::noLeftWall)) {
                *result = 8;
                return;
            }
        }
        {
            using _t = void (TurtlePult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TurtlePult::noRightWall)) {
                *result = 9;
                return;
            }
        }
        {
            using _t = void (TurtlePult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TurtlePult::Color)) {
                *result = 10;
                return;
            }
        }
        {
            using _t = void (TurtlePult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TurtlePult::Clean)) {
                *result = 11;
                return;
            }
        }
        {
            using _t = void (TurtlePult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TurtlePult::Rad)) {
                *result = 12;
                return;
            }
        }
        {
            using _t = void (TurtlePult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TurtlePult::Temp)) {
                *result = 13;
                return;
            }
        }
        {
            using _t = void (TurtlePult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TurtlePult::logToK)) {
                *result = 14;
                return;
            }
        }
        {
            using _t = void (TurtlePult::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TurtlePult::PultCmd)) {
                *result = 15;
                return;
            }
        }
        {
            using _t = void (TurtlePult::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TurtlePult::sendText)) {
                *result = 16;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject TurtlePult::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_TurtlePult.data,
    qt_meta_data_TurtlePult,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *TurtlePult::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::TurtlePult"))
        return static_cast< Ui::TurtlePult*>(this);
    return QWidget::qt_metacast(_clname);
}
