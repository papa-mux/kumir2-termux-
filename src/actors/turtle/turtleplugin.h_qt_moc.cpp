...
void ActorTurtle::TurtlePlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TurtlePlugin *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (TurtlePlugin::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TurtlePlugin::sync)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TurtlePlugin::*)(quint32 , const QVariantList & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TurtlePlugin::asyncRun)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (TurtlePlugin::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TurtlePlugin::notifyOnTemplateParametersChanged)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ActorTurtle::TurtlePlugin::staticMetaObject = { {
    QMetaObject::SuperData::link<ExtensionSystem::KPlugin::staticMetaObject>(),
    qt_meta_stringdata_ActorTurtle__TurtlePlugin.data,
    qt_meta_data_ActorTurtle__TurtlePlugin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
static constexpr unsigned char qt_pluginMetaData[] = {
    ...
    0xbf, 
    // "IID"
    0x02,  0x72,  'k',  'u',  'm',  'i',  'r',  '2', 
    '.',  'A',  'c',  't',  'o',  'r',  'T',  'u', 
    'r',  't',  'l',  'e', 
    // "className"
    0x03,  0x6c,  'T',  'u',  'r',  't',  'l',  'e', 
    'P',  'l',  'u',  'g',  'i',  'n', 
    0xff, 
};
