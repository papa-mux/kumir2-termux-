...
#ifndef TURTLEPLUGIN_H
#define TURTLEPLUGIN_H
    ...
    , public Shared::ActorInterface
{
    ...
    friend class TurtleAsyncRunThread;
    friend class TurtleModuleBase;
    Q_OBJECT
#if QT_VERSION >= 0x050000
    Q_PLUGIN_METADATA(IID "kumir2.ActorTurtle")
#endif
...
protected /* fields */:
    class TurtleModuleBase* module_;
    class TurtleAsyncRunThread* asyncRunThread_;
...
class TurtleAsyncRunThread
    : public QThread
{

public /* methods */:
    TurtleAsyncRunThread(class TurtlePlugin* plugin, class TurtleModuleBase* module);
