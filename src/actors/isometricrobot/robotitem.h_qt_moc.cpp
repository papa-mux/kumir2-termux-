...
void Robot25D::RobotItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RobotItem *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (RobotItem::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RobotItem::evaluationFinished)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (RobotItem::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RobotItem::startAnimationRequest)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Robot25D::RobotItem::staticMetaObject = { {
    QMetaObject::SuperData::link<QThread::staticMetaObject>(),
    qt_meta_stringdata_Robot25D__RobotItem.data,
    qt_meta_data_Robot25D__RobotItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
