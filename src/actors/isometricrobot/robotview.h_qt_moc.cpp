...
void Robot25D::RobotView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (RobotView::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RobotView::sync)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Robot25D::RobotView::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Robot25D__RobotView.data,
    qt_meta_data_Robot25D__RobotView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
