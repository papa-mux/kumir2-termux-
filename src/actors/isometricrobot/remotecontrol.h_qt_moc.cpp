...
void ActorIsometricRobot::SvgRemoteControl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SvgRemoteControl *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (SvgRemoteControl::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SvgRemoteControl::buttonPressed)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ActorIsometricRobot::SvgRemoteControl::staticMetaObject = { {
    QMetaObject::SuperData::link<QSvgWidget::staticMetaObject>(),
    qt_meta_stringdata_ActorIsometricRobot__SvgRemoteControl.data,
    qt_meta_data_ActorIsometricRobot__SvgRemoteControl,
    qt_static_metacall,
    nullptr,
    nullptr
} };
