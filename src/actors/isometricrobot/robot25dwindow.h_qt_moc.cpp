...
void Robot25DWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Robot25DWindow *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (Robot25DWindow::*)(const QSize & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Robot25DWindow::resizeRequest)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Robot25DWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QGraphicsView::staticMetaObject>(),
    qt_meta_stringdata_Robot25DWindow.data,
    qt_meta_data_Robot25DWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
