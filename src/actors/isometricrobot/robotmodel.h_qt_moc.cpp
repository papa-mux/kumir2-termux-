...
void Robot25D::RobotModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RobotModel *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (RobotModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RobotModel::robotCrashed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (RobotModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RobotModel::robotMoved)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (RobotModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RobotModel::robotTurnedLeft)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (RobotModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RobotModel::robotTurnedRight)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (RobotModel::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RobotModel::cellPainted)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (RobotModel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RobotModel::fieldChanged)) {
                *result = 5;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Robot25D::RobotModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Robot25D__RobotModel.data,
    qt_meta_data_Robot25D__RobotModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
