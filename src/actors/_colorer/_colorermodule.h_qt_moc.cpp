...
void Actor_Colorer::_ColorerModule::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<_ColorerModule *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Actor_Colorer::_ColorerModule::staticMetaObject = { {
    QMetaObject::SuperData::link<_ColorerModuleBase::staticMetaObject>(),
    qt_meta_stringdata_Actor_Colorer___ColorerModule.data,
    qt_meta_data_Actor_Colorer___ColorerModule,
    qt_static_metacall,
    nullptr,
    nullptr
} };
