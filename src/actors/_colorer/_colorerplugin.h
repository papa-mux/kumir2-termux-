...
#ifndef _COLORERPLUGIN_H
#define _COLORERPLUGIN_H
...
class _ColorerPlugin
    : public ExtensionSystem::KPlugin
    , public Shared::ActorInterface
{

    friend class _ColorerAsyncRunThread;
    friend class _ColorerModuleBase;
    Q_OBJECT
#if QT_VERSION >= 0x050000
    Q_PLUGIN_METADATA(IID "kumir2.Actor_Colorer")
#endif
...
protected /* fields */:
    class _ColorerModuleBase* module_;
    class _ColorerAsyncRunThread* asyncRunThread_;
...
class _ColorerAsyncRunThread
    : public QThread
{

public /* methods */:
    _ColorerAsyncRunThread(class _ColorerPlugin* plugin, class _ColorerModuleBase* module);
