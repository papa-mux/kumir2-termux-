    ...
    , public Shared::ActorInterface
{
    ...
    friend class DrawAsyncRunThread;
    friend class DrawModuleBase;
    Q_OBJECT
#if QT_VERSION >= 0x050000
    Q_PLUGIN_METADATA(IID "kumir2.ActorDraw")
#endif
...
protected /* fields */:
    class DrawModuleBase* module_;
    class DrawAsyncRunThread* asyncRunThread_;
...
class DrawAsyncRunThread
    : public QThread
{

public /* methods */:
    DrawAsyncRunThread(class DrawPlugin* plugin, class DrawModuleBase* module);
