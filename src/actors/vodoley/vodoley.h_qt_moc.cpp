...
void Vodoley::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Vodoley *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (Vodoley::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Vodoley::Otkaz)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Vodoley::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Vodoley::Ok)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Vodoley::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Vodoley::CNull)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Vodoley::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Vodoley::CNotNull)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (Vodoley::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Vodoley::FileLoaded)) {
                *result = 4;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Vodoley::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_Vodoley.data,
    qt_meta_data_Vodoley,
    qt_static_metacall,
    nullptr,
    nullptr
} };
