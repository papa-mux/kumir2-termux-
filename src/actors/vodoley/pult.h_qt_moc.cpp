...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<VodoleyPult *>(_o);
        (void)_t;
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (VodoleyPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VodoleyPult::goUp)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (VodoleyPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VodoleyPult::goDown)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (VodoleyPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VodoleyPult::goLeft)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (VodoleyPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VodoleyPult::goRight)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (VodoleyPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VodoleyPult::hasLeftWall)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (VodoleyPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VodoleyPult::hasRightWall)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (VodoleyPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VodoleyPult::noUpWall)) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (VodoleyPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VodoleyPult::noDownWall)) {
                *result = 7;
                return;
            }
        }
        {
            using _t = void (VodoleyPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VodoleyPult::noLeftWall)) {
                *result = 8;
                return;
            }
        }
        {
            using _t = void (VodoleyPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VodoleyPult::noRightWall)) {
                *result = 9;
                return;
            }
        }
        {
            using _t = void (VodoleyPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VodoleyPult::Color)) {
                *result = 10;
                return;
            }
        }
        {
            using _t = void (VodoleyPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VodoleyPult::Clean)) {
                *result = 11;
                return;
            }
        }
        {
            using _t = void (VodoleyPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VodoleyPult::Rad)) {
                *result = 12;
                return;
            }
        }
        {
            using _t = void (VodoleyPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VodoleyPult::Temp)) {
                *result = 13;
                return;
            }
        }
        {
            using _t = void (VodoleyPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VodoleyPult::logToK)) {
                *result = 14;
                return;
            }
        }
        {
            using _t = void (VodoleyPult::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VodoleyPult::PultCmd)) {
                *result = 15;
                return;
            }
        }
        {
            using _t = void (VodoleyPult::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VodoleyPult::sendText)) {
                *result = 16;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject VodoleyPult::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_VodoleyPult.data,
    qt_meta_data_VodoleyPult,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *VodoleyPult::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::VodoleyPult"))
        return static_cast< Ui::VodoleyPult*>(this);
    return QWidget::qt_metacast(_clname);
}
