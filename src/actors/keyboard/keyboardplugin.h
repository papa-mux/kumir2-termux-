    ...
    , public Shared::ActorInterface
{
    ...
    friend class KeyboardAsyncRunThread;
    friend class KeyboardModuleBase;
    Q_OBJECT
#if QT_VERSION >= 0x050000
    Q_PLUGIN_METADATA(IID "kumir2.ActorKeyboard")
#endif
...
protected /* fields */:
    class KeyboardModuleBase* module_;
    class KeyboardAsyncRunThread* asyncRunThread_;
...
class KeyboardAsyncRunThread
    : public QThread
{

public /* methods */:
    KeyboardAsyncRunThread(class KeyboardPlugin* plugin, class KeyboardModuleBase* module);
