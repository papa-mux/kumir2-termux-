...
void ActorPainter::PainterNewImageDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PainterNewImageDialog *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ActorPainter::PainterNewImageDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_ActorPainter__PainterNewImageDialog.data,
    qt_meta_data_ActorPainter__PainterNewImageDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
