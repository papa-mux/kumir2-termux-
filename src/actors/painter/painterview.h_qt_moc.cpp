...
void ActorPainter::PainterView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (PainterView::*)(int , int , const QColor & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PainterView::cursorOver)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ActorPainter::PainterView::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ActorPainter__PainterView.data,
    qt_meta_data_ActorPainter__PainterView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
