    ...
    , public Shared::ActorInterface
{
    ...
    friend class PainterAsyncRunThread;
    friend class PainterModuleBase;
    Q_OBJECT
#if QT_VERSION >= 0x050000
    Q_PLUGIN_METADATA(IID "kumir2.ActorPainter")
#endif
...
protected /* fields */:
    class PainterModuleBase* module_;
    class PainterAsyncRunThread* asyncRunThread_;
...
class PainterAsyncRunThread
    : public QThread
{

public /* methods */:
    PainterAsyncRunThread(class PainterPlugin* plugin, class PainterModuleBase* module);
