...
void ActorPainter::PainterModuleBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PainterModuleBase *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (PainterModuleBase::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PainterModuleBase::notifyOnTemplateParametersChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ActorPainter::PainterModuleBase::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_ActorPainter__PainterModuleBase.data,
    qt_meta_data_ActorPainter__PainterModuleBase,
    qt_static_metacall,
    nullptr,
    nullptr
} };
