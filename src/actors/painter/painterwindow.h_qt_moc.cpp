...
void ActorPainter::PainterWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PainterWindow *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ActorPainter::PainterWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ActorPainter__PainterWindow.data,
    qt_meta_data_ActorPainter__PainterWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
