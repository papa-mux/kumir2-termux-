/****************************************************************************
** Meta object code from reading C++ file 'srobot.h'
**
...
#include <memory>
#include "../../../../src/actors/robot/srobot.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'srobot.h' doesn't include <QObject>."
...
void ActorRobot::SimpleRobot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SimpleRobot *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (SimpleRobot::*)(QPointF );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SimpleRobot::moved)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ActorRobot::SimpleRobot::staticMetaObject = { {
    QMetaObject::SuperData::link<QGraphicsObject::staticMetaObject>(),
    qt_meta_stringdata_ActorRobot__SimpleRobot.data,
    qt_meta_data_ActorRobot__SimpleRobot,
    qt_static_metacall,
    nullptr,
    nullptr
} };
