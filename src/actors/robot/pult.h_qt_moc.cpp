...
void RoboPult::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RoboPult *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (RoboPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RoboPult::goUp)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (RoboPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RoboPult::robReset)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (RoboPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RoboPult::goDown)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (RoboPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RoboPult::goLeft)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (RoboPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RoboPult::goRight)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (RoboPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RoboPult::hasUpWall)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (RoboPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RoboPult::hasDownWall)) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (RoboPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RoboPult::hasLeftWall)) {
                *result = 7;
                return;
            }
        }
        {
            using _t = void (RoboPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RoboPult::hasRightWall)) {
                *result = 8;
                return;
            }
        }
        {
            using _t = void (RoboPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RoboPult::noUpWall)) {
                *result = 9;
                return;
            }
        }
        {
            using _t = void (RoboPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RoboPult::noDownWall)) {
                *result = 10;
                return;
            }
        }
        {
            using _t = void (RoboPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RoboPult::noLeftWall)) {
                *result = 11;
                return;
            }
        }
        {
            using _t = void (RoboPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RoboPult::noRightWall)) {
                *result = 12;
                return;
            }
        }
        {
            using _t = void (RoboPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RoboPult::Color)) {
                *result = 13;
                return;
            }
        }
        {
            using _t = void (RoboPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RoboPult::Clean)) {
                *result = 14;
                return;
            }
        }
        {
            using _t = void (RoboPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RoboPult::Colored)) {
                *result = 15;
                return;
            }
        }
        {
            using _t = void (RoboPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RoboPult::Rad)) {
                *result = 16;
                return;
            }
        }
        {
            using _t = void (RoboPult::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RoboPult::Temp)) {
                *result = 17;
                return;
            }
        }
        {
            using _t = void (RoboPult::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RoboPult::PultCmd)) {
                *result = 18;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject RoboPult::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_RoboPult.data,
    qt_meta_data_RoboPult,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *RoboPult::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::RoboPult"))
        return static_cast< Ui::RoboPult*>(this);
