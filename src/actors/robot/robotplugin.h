    ...
    , public Shared::ActorInterface
{
    ...
    friend class RobotAsyncRunThread;
    friend class RobotModuleBase;
    Q_OBJECT
#if QT_VERSION >= 0x050000
...
protected /* fields */:
    class RobotModuleBase* module_;
    class RobotAsyncRunThread* asyncRunThread_;
...
public /* methods */:
    RobotAsyncRunThread(class RobotPlugin* plugin, class RobotModuleBase* module);
