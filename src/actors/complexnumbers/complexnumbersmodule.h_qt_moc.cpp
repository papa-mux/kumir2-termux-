...
void ActorComplexNumbers::ComplexNumbersModule::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ComplexNumbersModule *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ActorComplexNumbers::ComplexNumbersModule::staticMetaObject = { {
    QMetaObject::SuperData::link<ComplexNumbersModuleBase::staticMetaObject>(),
    qt_meta_stringdata_ActorComplexNumbers__ComplexNumbersModule.data,
    qt_meta_data_ActorComplexNumbers__ComplexNumbersModule,
    qt_static_metacall,
    nullptr,
    nullptr
} };
