...
#ifndef COMPLEXNUMBERSPLUGIN_H
#define COMPLEXNUMBERSPLUGIN_H
...
class ComplexNumbersPlugin
    : public ExtensionSystem::KPlugin
    , public Shared::ActorInterface
{

    friend class ComplexNumbersAsyncRunThread;
    friend class ComplexNumbersModuleBase;
    Q_OBJECT
#if QT_VERSION >= 0x050000
    Q_PLUGIN_METADATA(IID "kumir2.ActorComplexNumbers")
#endif
    Q_INTERFACES(Shared::ActorInterface)
        
public /* methods */:
    ComplexNumbersPlugin();
    QVariantList algOptResults() const;
    QByteArray asciiModuleName() const;
    void connectSync(QObject* receiver, const char* method);
    QVariant customValueFromString(const QByteArray & clazz, const QString & stringg) const;
    QString customValueToString(const QByteArray & clazz, const QVariant & value) const;
...
protected /* fields */:
    class ComplexNumbersModuleBase* module_;
    class ComplexNumbersAsyncRunThread* asyncRunThread_;
...
class ComplexNumbersAsyncRunThread
    : public QThread
{

public /* methods */:
    ComplexNumbersAsyncRunThread(class ComplexNumbersPlugin* plugin, class ComplexNumbersModuleBase* module);
...
protected /* fields */:
    quint32 index_;
    QVariantList args_;
    class ComplexNumbersPlugin* plugin_;
    class ComplexNumbersModuleBase* module_;
