...
void ActorGrasshopper::GrasshopperModuleBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GrasshopperModuleBase *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (GrasshopperModuleBase::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GrasshopperModuleBase::notifyOnTemplateParametersChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ActorGrasshopper::GrasshopperModuleBase::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_ActorGrasshopper__GrasshopperModuleBase.data,
    qt_meta_data_ActorGrasshopper__GrasshopperModuleBase,
    qt_static_metacall,
    nullptr,
    nullptr
} };
