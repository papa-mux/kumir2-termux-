...
#ifndef GRASSHOPPERPLUGIN_H
#define GRASSHOPPERPLUGIN_H
...
class GrasshopperPlugin
    : public ExtensionSystem::KPlugin
    , public Shared::ActorInterface
{

    friend class GrasshopperAsyncRunThread;
    friend class GrasshopperModuleBase;
    Q_OBJECT
#if QT_VERSION >= 0x050000
    Q_PLUGIN_METADATA(IID "kumir2.ActorGrasshopper")
#endif
...
protected /* fields */:
    class GrasshopperModuleBase* module_;
    class GrasshopperAsyncRunThread* asyncRunThread_;
...
class GrasshopperAsyncRunThread
    : public QThread
{

public /* methods */:
    GrasshopperAsyncRunThread(class GrasshopperPlugin* plugin, class GrasshopperModuleBase* module);
...
protected /* fields */:
    quint32 index_;
    QVariantList args_;
    class GrasshopperPlugin* plugin_;
    class GrasshopperModuleBase* module_;
