...
void ActorGrasshopper::GrasshopperModule::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GrasshopperModule *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ActorGrasshopper::GrasshopperModule::staticMetaObject = { {
    QMetaObject::SuperData::link<GrasshopperModuleBase::staticMetaObject>(),
    qt_meta_stringdata_ActorGrasshopper__GrasshopperModule.data,
    qt_meta_data_ActorGrasshopper__GrasshopperModule,
    qt_static_metacall,
    nullptr,
    nullptr
} };
