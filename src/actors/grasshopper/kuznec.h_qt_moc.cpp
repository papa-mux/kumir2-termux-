...
void KumScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<KumScene *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (KumScene::*)(qreal , qreal , bool , qreal , qreal );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&KumScene::MousePress)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (KumScene::*)(qreal , qreal , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&KumScene::MouseRelease)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (KumScene::*)(int , int , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&KumScene::MouseMove)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (KumScene::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&KumScene::MouseWheel)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject KumScene::staticMetaObject = { {
    QMetaObject::SuperData::link<QGraphicsScene::staticMetaObject>(),
    qt_meta_stringdata_KumScene.data,
    qt_meta_data_KumScene,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<KumKuznec *>(_o);
        (void)_t;
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (KumKuznec::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&KumKuznec::sync)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject KumKuznec::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_KumKuznec.data,
    qt_meta_data_KumKuznec,
    qt_static_metacall,
    nullptr,
    nullptr
} };
