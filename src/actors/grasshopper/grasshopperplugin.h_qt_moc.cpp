...
void ActorGrasshopper::GrasshopperPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GrasshopperPlugin *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (GrasshopperPlugin::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GrasshopperPlugin::sync)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (GrasshopperPlugin::*)(quint32 , const QVariantList & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GrasshopperPlugin::asyncRun)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (GrasshopperPlugin::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GrasshopperPlugin::notifyOnTemplateParametersChanged)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ActorGrasshopper::GrasshopperPlugin::staticMetaObject = { {
    QMetaObject::SuperData::link<ExtensionSystem::KPlugin::staticMetaObject>(),
    qt_meta_stringdata_ActorGrasshopper__GrasshopperPlugin.data,
    qt_meta_data_ActorGrasshopper__GrasshopperPlugin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
static constexpr unsigned char qt_pluginMetaData[] = {
    ...
    0xbf, 
    // "IID"
    0x02,  0x77,  'k',  'u',  'm',  'i',  'r',  '2', 
    '.',  'A',  'c',  't',  'o',  'r',  'G',  'r', 
    'a',  's',  's',  'h',  'o',  'p',  'p',  'e', 
    'r', 
    // "className"
    0x03,  0x71,  'G',  'r',  'a',  's',  's',  'h', 
    'o',  'p',  'p',  'e',  'r',  'P',  'l',  'u', 
    'g',  'i',  'n', 
    0xff, 
};
