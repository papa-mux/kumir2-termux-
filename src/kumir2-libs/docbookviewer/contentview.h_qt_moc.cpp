...
void DocBookViewer::ContentView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ContentView::*)(ModelPtr );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ContentView::itemRequest)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DocBookViewer::ContentView::staticMetaObject = { {
    QMetaObject::SuperData::link<QTextBrowser::staticMetaObject>(),
    qt_meta_stringdata_DocBookViewer__ContentView.data,
    qt_meta_data_DocBookViewer__ContentView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *DocBookViewer::ContentView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ContentRenderer"))
        return static_cast< ContentRenderer*>(this);
