...
void DocBookViewer::DocBookViewImpl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DocBookViewImpl *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (DocBookViewImpl::*)(ModelPtr );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DocBookViewImpl::itemSelected)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DocBookViewer::DocBookViewImpl::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_DocBookViewer__DocBookViewImpl.data,
    qt_meta_data_DocBookViewer__DocBookViewImpl,
    qt_static_metacall,
    nullptr,
    nullptr
} };
