...
void DocBookViewer::SidePanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SidePanel::*)(ModelPtr );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SidePanel::itemPicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DocBookViewer::SidePanel::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_DocBookViewer__SidePanel.data,
    qt_meta_data_DocBookViewer__SidePanel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
