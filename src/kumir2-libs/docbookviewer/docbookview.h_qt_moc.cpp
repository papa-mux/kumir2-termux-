...
QT_INIT_METAOBJECT const QMetaObject DocBookViewer::DocBookView::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_DocBookViewer__DocBookView.data,
    qt_meta_data_DocBookViewer__DocBookView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
