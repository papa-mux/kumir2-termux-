...
void Widgets::DeclarativeSettingsPageImpl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DeclarativeSettingsPageImpl *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Widgets::DeclarativeSettingsPageImpl::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Widgets__DeclarativeSettingsPageImpl.data,
    qt_meta_data_Widgets__DeclarativeSettingsPageImpl,
    qt_static_metacall,
    nullptr,
    nullptr
} };
