...
void loggerButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<loggerButton *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (loggerButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&loggerButton::pressed)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject loggerButton::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_loggerButton.data,
    qt_meta_data_loggerButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<pultLogger *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject pultLogger::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_pultLogger.data,
    qt_meta_data_pultLogger,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject linkLight::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_linkLight.data,
    qt_meta_data_linkLight,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MainButton *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->pressed(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MainButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainButton::pressed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MainButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainButton::clicked)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MainButton::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_MainButton.data,
    qt_meta_data_MainButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
