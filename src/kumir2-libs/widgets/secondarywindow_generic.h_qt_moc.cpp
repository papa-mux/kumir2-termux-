...
void Widgets::SecondaryWindowGenericImplementation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SecondaryWindowGenericImplementation *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Widgets::SecondaryWindowGenericImplementation::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Widgets__SecondaryWindowGenericImplementation.data,
    qt_meta_data_Widgets__SecondaryWindowGenericImplementation,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Widgets::SecondaryWindowGenericImplementation::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "SecondaryWindowImplementationInterface"))
        return static_cast< SecondaryWindowImplementationInterface*>(this);
