...
QT_INIT_METAOBJECT const QMetaObject Widgets::SecondaryWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Widgets__SecondaryWindow.data,
    qt_meta_data_Widgets__SecondaryWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
