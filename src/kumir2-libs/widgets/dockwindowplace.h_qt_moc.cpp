...
void Widgets::DockWindowPlace::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DockWindowPlace *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (DockWindowPlace::*)(bool , const QSize & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DockWindowPlace::visiblityRequest)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (DockWindowPlace::*)(const QSize & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DockWindowPlace::resizeRequest)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Widgets::DockWindowPlace::staticMetaObject = { {
    QMetaObject::SuperData::link<QTabWidget::staticMetaObject>(),
    qt_meta_stringdata_Widgets__DockWindowPlace.data,
    qt_meta_data_Widgets__DockWindowPlace,
    qt_static_metacall,
    nullptr,
    nullptr
} };
