...
void Widgets::DeclarativeSettingsPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DeclarativeSettingsPage *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (DeclarativeSettingsPage::*)(const QStringList & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DeclarativeSettingsPage::settingsChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Widgets::DeclarativeSettingsPage::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Widgets__DeclarativeSettingsPage.data,
    qt_meta_data_Widgets__DeclarativeSettingsPage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
