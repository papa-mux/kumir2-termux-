...
void Widgets::MultiPageDialogImpl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MultiPageDialogImpl *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Widgets::MultiPageDialogImpl::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Widgets__MultiPageDialogImpl.data,
    qt_meta_data_Widgets__MultiPageDialogImpl,
    qt_static_metacall,
    nullptr,
    nullptr
} };
