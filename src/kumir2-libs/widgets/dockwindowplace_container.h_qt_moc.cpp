...
void Widgets::DockWindowPlaceContainer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DockWindowPlaceContainer *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (DockWindowPlaceContainer::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DockWindowPlaceContainer::resizeRequest)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Widgets::DockWindowPlaceContainer::staticMetaObject = { {
    QMetaObject::SuperData::link<SecondaryWindowGenericImplementation::staticMetaObject>(),
    qt_meta_stringdata_Widgets__DockWindowPlaceContainer.data,
    qt_meta_data_Widgets__DockWindowPlaceContainer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
