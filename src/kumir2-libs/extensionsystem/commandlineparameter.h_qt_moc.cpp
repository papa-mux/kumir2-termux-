...
QT_INIT_METAOBJECT const QMetaObject ExtensionSystem::CommandLineParameter::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_ExtensionSystem__CommandLineParameter.data,
    qt_meta_data_ExtensionSystem__CommandLineParameter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
