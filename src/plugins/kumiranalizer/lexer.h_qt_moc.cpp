...
QT_INIT_METAOBJECT const QMetaObject KumirAnalizer::Lexer::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_KumirAnalizer__Lexer.data,
    qt_meta_data_KumirAnalizer__Lexer,
    qt_static_metacall,
    nullptr,
    nullptr
} };
