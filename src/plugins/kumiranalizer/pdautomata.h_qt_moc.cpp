...
void KumirAnalizer::PDAutomata::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PDAutomata *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject KumirAnalizer::PDAutomata::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_KumirAnalizer__PDAutomata.data,
    qt_meta_data_KumirAnalizer__PDAutomata,
    qt_static_metacall,
    nullptr,
    nullptr
} };
