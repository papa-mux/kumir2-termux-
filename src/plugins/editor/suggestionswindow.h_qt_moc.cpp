...
void Editor::SuggestionsWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SuggestionsWindow *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (SuggestionsWindow::*)(const QString & , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SuggestionsWindow::requestHelpForAlgorithm)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SuggestionsWindow::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SuggestionsWindow::acceptedSuggestion)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SuggestionsWindow::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SuggestionsWindow::hidden)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Editor::SuggestionsWindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Editor__SuggestionsWindow.data,
    qt_meta_data_Editor__SuggestionsWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
