...
void Editor::MacroListEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MacroListEditor *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Editor::MacroListEditor::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_Editor__MacroListEditor.data,
    qt_meta_data_Editor__MacroListEditor,
    qt_static_metacall,
    nullptr,
    nullptr
} };
