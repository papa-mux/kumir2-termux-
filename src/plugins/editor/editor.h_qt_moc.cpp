...
void Editor::EditorInstance::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<EditorInstance *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (EditorInstance::*)(const QList<QUrl> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EditorInstance::urlsDragAndDropped)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (EditorInstance::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EditorInstance::documentCleanChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (EditorInstance::*)(uint , uint );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EditorInstance::cursorPositionChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (EditorInstance::*)(QLocale::Language , bool , bool , bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EditorInstance::keyboardLayoutChanged)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (EditorInstance::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EditorInstance::message)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (EditorInstance::*)(const QString & , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EditorInstance::requestHelpForAlgorithm)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (EditorInstance::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EditorInstance::recordMacroChanged)) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (EditorInstance::*)(bool , quint32 , quint32 , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EditorInstance::breakpointCnagedOrInserted)) {
                *result = 7;
                return;
            }
        }
        {
            using _t = void (EditorInstance::*)(quint32 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EditorInstance::breakpointRemoved)) {
                *result = 8;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Editor::EditorInstance::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Editor__EditorInstance.data,
    qt_meta_data_Editor__EditorInstance,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Editor::EditorInstance::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Shared::Editor::InstanceInterface"))
        return static_cast< Shared::Editor::InstanceInterface*>(this);
