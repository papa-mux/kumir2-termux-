...
void Editor::Clipboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: { ClipboardData _r = _t->content();
            if (_a[0]) *reinterpret_cast< ClipboardData*>(_a[0]) = std::move(_r); }  break;
        ...
        {
            using _t = void (Clipboard::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Clipboard::bufferEntriesCountChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Editor::Clipboard::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Editor__Clipboard.data,
    qt_meta_data_Editor__Clipboard,
    qt_static_metacall,
    nullptr,
    nullptr
} };
