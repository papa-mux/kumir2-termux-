...
void Editor::TextCursor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TextCursor *>(_o);
        (void)_t;
        switch (_id) {
        ...
        case 13: { QSharedPointer<Macro> _r = _t->endRecordMacro();
            if (_a[0]) *reinterpret_cast< QSharedPointer<Macro>*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (TextCursor::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TextCursor::positionChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TextCursor::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TextCursor::updateRequest)) {
                *result = 1;
                return;
            }
        }
        ...
        {
            using _t = void (TextCursor::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TextCursor::undoAvailable)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (TextCursor::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TextCursor::redoAvailable)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (TextCursor::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TextCursor::signalizeNotEditable)) {
                *result = 5;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Editor::TextCursor::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Editor__TextCursor.data,
    qt_meta_data_Editor__TextCursor,
    qt_static_metacall,
    nullptr,
    nullptr
} };
