...
void Terminal::Plane::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Plane::inputTextChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Plane::*)(quint16 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Plane::inputCursorPositionChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Plane::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Plane::inputFinishRequest)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Plane::*)(char );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Plane::requestAutoScrollX)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (Plane::*)(char );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Plane::requestAutoScrollY)) {
                *result = 4;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Terminal::Plane::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Terminal__Plane.data,
    qt_meta_data_Terminal__Plane,
    qt_static_metacall,
    nullptr,
    nullptr
} };
