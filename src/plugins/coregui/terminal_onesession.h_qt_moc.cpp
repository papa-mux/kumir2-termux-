...
void Terminal::OneSession::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<OneSession *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (OneSession::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OneSession::updateRequest)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (OneSession::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OneSession::message)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (OneSession::*)(const QVariantList & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OneSession::inputDone)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Terminal::OneSession::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Terminal__OneSession.data,
    qt_meta_data_Terminal__OneSession,
    qt_static_metacall,
    nullptr,
    nullptr
} };
