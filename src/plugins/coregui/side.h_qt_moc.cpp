...
void CoreGUI::Side::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Side::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Side::visiblityRequest)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CoreGUI::Side::staticMetaObject = { {
    QMetaObject::SuperData::link<QSplitter::staticMetaObject>(),
    qt_meta_stringdata_CoreGUI__Side.data,
    qt_meta_data_CoreGUI__Side,
    qt_static_metacall,
    nullptr,
    nullptr
} };
