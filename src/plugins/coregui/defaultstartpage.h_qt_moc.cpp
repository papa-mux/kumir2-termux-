...
void CoreGUI::DefaultStartPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DefaultStartPage *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject CoreGUI::DefaultStartPage::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CoreGUI__DefaultStartPage.data,
    qt_meta_data_CoreGUI__DefaultStartPage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *CoreGUI::DefaultStartPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Shared::StartpageWidgetInterface"))
        return static_cast< Shared::StartpageWidgetInterface*>(this);
