...
QT_INIT_METAOBJECT const QMetaObject CoreGUI::AboutDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_CoreGUI__AboutDialog.data,
    qt_meta_data_CoreGUI__AboutDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
