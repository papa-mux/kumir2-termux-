...
void CoreGUI::TabWidgetElement::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TabWidgetElement *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (TabWidgetElement::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TabWidgetElement::titleChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (TabWidgetElement::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TabWidgetElement::documentCleanChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (TabWidgetElement::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TabWidgetElement::explicitImportNamesRequest)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CoreGUI::TabWidgetElement::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CoreGUI__TabWidgetElement.data,
    qt_meta_data_CoreGUI__TabWidgetElement,
    qt_static_metacall,
    nullptr,
    nullptr
} };
