...
QT_MOC_LITERAL(9, 97, 17) // "handleRowsRemoved"

    },
    "CoreGUI::DebuggerView\0setDebuggerEnabled\0"
    "\0enabled\0handleRowsInserted\0QModelIndex\0"
    "index\0start\0end\0handleRowsRemoved"
};
...
void CoreGUI::DebuggerView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DebuggerView *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject CoreGUI::DebuggerView::staticMetaObject = { {
    QMetaObject::SuperData::link<QTreeView::staticMetaObject>(),
    qt_meta_stringdata_CoreGUI__DebuggerView.data,
    qt_meta_data_CoreGUI__DebuggerView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
